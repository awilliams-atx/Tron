...
GameView.prototype.addEventListeners = function () {
  ...
  this.DOM.newGame.el.addEventListener('click', this.listeners.newGame);
...
GameView.prototype.instructionsBack = function () {
  var instructionsBack = this.DOM['instructionsBack.el'];
};
...
GameView.prototype.menuListenInstructions = function (emptyKlass) {
  if (emptyKlass) {
    this.DOM.instructionsButton.el.innerHTML = '';
    this.DOM.instructionsButton.el.removeAttribute('class');
  } else {
    this.DOM.instructionsButton.el.innerHTML = 'Instructions';
...
GameView.prototype.menuListenNewGame = function (emptyKlass) {
  if (emptyKlass) {
    this.DOM.newGame.el.innerHTML = '';
    this.DOM.newGame.el.removeAttribute('class');
  } else {
    this.DOM.newGame.el.innerHTML = 'New Game';
