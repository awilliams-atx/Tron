...
/***/ function(module, exports) {
	...
	var DOM = {
	  ...
	  singlePlayer: {
	    ...
	    klasses: [
	      'nowhere', 'single-player-transparent', 'single-player-fly-in', 'single-player-transparent'
	    ]
	  },
	  twoPlayer: {
	    cycle: 0,
	    ...
	    klasses: [
	      'nowhere', 'two-player-transparent', 'two-player-fly-in', 'two-player-transparent'
	    ]
	  },
	  outerMenu: {
...
/***/ function(module, exports) {
	...
	var DOMUtil = {
	  ...
	  deklassify: function (domEl, timeout) {
	    timeout = timeout || 0;
	    setTimeout(function () {
	      domEl.el.setAttribute('class', domEl.deklassify);
	    }, timeout);
	  },
	  ...
	  klassify: function (domEl, timeout) {
	    timeout = timeout || 0;
	    setTimeout(function () {
	      domEl.el.setAttribute('class', domEl.klassify);
	    }, timeout);
	  },
