...
/***/ function(module, exports, __webpack_require__) {
	...
	var GameStarter = __webpack_require__(1);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Constants = __webpack_require__(2),
	    CycleUtil = __webpack_require__(5);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CanvasUtil = __webpack_require__(7),
	    Constants = __webpack_require__(2),
	    DOMUtil = __webpack_require__(8),
	    Game = __webpack_require__(3);
	...
	GameView.prototype.flyInMenuItems = function () {
	  ...
	  setTimeout(function () {
	    ...
	    DOMUtil.flyIn(this.DOM.instructionsButton, 200);
	  }.bind(this), 500)
	};
	
	GameView.prototype.flyOutMenuItems = function () {
	  DOMUtil.flyOut(this.DOM.instructionsButton);
	  DOMUtil.flyOut(this.DOM.newGameButton, 100);
	  DOMUtil.flyOut(this.DOM.announcement, 200);
	};
	...
	GameView.prototype.initializeListeners = function () {
	  this.listeners = {
	    ...
	    instructions: function () {
	      this.flyOutMenuItems();
	      console.log('instructions flyOutMenuItems');
	      DOMUtil.fadeToBlack(function () {
	        DOMUtil.undisplay(this.DOM.outerMenu, 400);
