	...
	GameView.prototype.initializeListeners = function () {
	  this.listeners = {
	    ...
	    newGameButton: function () {
	      ...
	      DOMUtil.fadeToBlack(function () {
	        DOMUtil.undisplay(DOM.outerMenu);
	        this.promptGameTypeSelection();
	      }.bind(this), 200);
	    }.bind(this),
	    newSinglePlayerGame: function () {
	      DOMUtil.deklassify(DOM.singlePlayer);
	      DOMUtil.deklassify(DOM.twoPlayer);
	      this.newGame(1);
	    }.bind(this),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CanvasUtil = __webpack_require__(2),
	    Computer = __webpack_require__(9),
	    Constants = __webpack_require__(3),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ComputerUtil = __webpack_require__(10),
	    Constants = __webpack_require__(3),
	    CycleUtil = __webpack_require__(8);
	...
	Computer.prototype.isAboutToCollide = function () {
	  return ComputerUtil.isAboutToCollide(this.pos, this.direction);
	};
