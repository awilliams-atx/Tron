...
Cycle.prototype.move = function () {
  ...
  if (prevPos[0] === this.pos[0]) {
    this.forbiddenVels = ['[0, 1]', '[0, -1]'];
  } else if (prevPos[1] === this.pos[1]) {
    this.forbiddenVels = ['[1, 0]', '[-1, 0]'];
  }
};
...
Cycle.prototype.requestTurn = function (vel, velStr) {
  ...
  this.forbiddenVels.forEach(function (forbiddenVel) {
